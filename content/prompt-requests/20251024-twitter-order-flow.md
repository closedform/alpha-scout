...
- Deliverable: Produce **up to 5 distinct ideas** using the exact schema below, in order, one after another. Use concise, technical prose.
...
- **Query / Filters:** equity order flow alpha
- **Scan Window:** 2024-08-01 - 2024-08-31
